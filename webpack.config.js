...
module.exports = {
  ...
  entry: [
    ...
    // __dirname + "/src/js/ag-main-2022.js",
    // __dirname + "/src/js/ag-cart-2022.js",
    // __dirname + "/src/js/ag-category-2022.js",
    ...
    __dirname + "/src/scss/ag-main-2022.scss",
  ],
  output: {
    ...
    // filename: "ag-main-2022.js",
    // filename: "ag-category-2022.js",
  },
  plugins: [
